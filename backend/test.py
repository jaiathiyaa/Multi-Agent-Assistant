...
# Loading weights: 100%|████████████████████████████████████████████████████████████████████████████████████████████████| 103/103 [00:00<00:00, 1823.79it/s]
# Model loaded successfully.
# Vector store initialized at /home/jaiathiyaa/Desktop/Multi-Agent-Assistant/backend/db/vector_store.
# Vector store already populated, skipping.
# Synthesized Answer:
#  Introduction
#
# The latest advancements in AI technology are being rapidly developed and implemented across various industries. This analysis aims to extract key findings from recent sources to provide an overview of the current state of AI technology.
#
# Key Findings
# - Finding 1 [Web]: Major model launches and record funding rounds have been shaping business, work, and education in the first half of 2026. (Source: Crescendo.ai)
# - Finding 2 [Web]: The top AI trends include 5 developments that have driven the first half of the year and 5 more expected to play a major role in the months to come. (Source: IBM)
#
# Conclusion
#
# The latest advancements in AI technology are being driven by major model launches, record funding rounds, and breakthroughs in various industries. As AI continues to evolve, it is expected to play a significant role in shaping business, work, and education in the months to come.
#
# Critique:
#  Verified Claims:
# - "Major model launches and record funding rounds have been shaping business, work, and education in the first half of 2026."
# - "The top AI trends include 5 developments that have driven the first half of the year and 5 more expected to play a major role in the months to come."
#
# Unsupported Claims:
# - "The latest advancements in AI technology are being driven by major model launches, record funding rounds, and breakthroughs in various industries."
# - "As AI continues to evolve, it is expected to play a significant role in shaping business, work, and education in the months to come."
#
# Contradicted Claims:
# - None
#
# Overall Confidence Score: 60
# Reasoning: The confidence score is moderate because while some specific claims are supported by web context, other claims are unsupported due to lack of direct evidence, and there is no contradictory information found in the provided contexts.
...
db_path = "/home/jaiathiyaa/Desktop/DocumentAI/backend/db/vector_store/chroma.sqlite3"
...
print(f"Collections in SQLite: {len(rows)}")
for row in rows:
